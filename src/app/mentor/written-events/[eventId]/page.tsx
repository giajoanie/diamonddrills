  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        <p className="mt-1 text-foreground-muted">Checklist and milestone deadlines</p>
        ...
        <Card className="mt-4">
            ...
            {milestones.map((m) => (
              <div key={m.id} className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-sm text-foreground-muted">{m.dueAt.toLocaleString()}</p>
          ...
          <form action={createMilestone} className="mt-4 flex flex-wrap items-end gap-3 border-t border-border pt-4">
            <input type="hidden" name="eventId" value={eventId} />
            <div>
