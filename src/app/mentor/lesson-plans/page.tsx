        ...
        <TabbedCard tabs={getMentorTabs()}>
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-1 text-foreground-muted">
              Rule-based suggestions from the weakest instructional areas — each
              one explains why it was made.
            </p>
              ...
              {recommendations.map((r) => (
                <Card key={r.areaId}>
                  ...
                  <p className="mt-3 text-sm font-medium text-foreground">
                    Suggested practice exam
                  </p>
                  <p className="text-sm text-foreground-muted">
                    {r.examConfig.questionCount} questions ·{" "}
                    {r.examConfig.timeLimitMinutes} minutes
                  </p>
                  ...
                  <p className="mt-3 text-sm font-medium text-foreground">
                    ...
                    {r.beneficiaryStudentIds.length})
                  </p>
                  {r.beneficiaryStudentIds.length > 0 ? (
                    ...
                    <p className="text-sm text-foreground-muted">
                      No students below the benefit threshold.
                    </p>
                  )}
                </Card>
              ))}
              ...
              {recommendations.length === 0 && (
                <Card>
                  <p className="text-foreground-muted">
                    Not enough exam data yet to generate recommendations.
                  </p>
                </Card>
              )}
            </div>
